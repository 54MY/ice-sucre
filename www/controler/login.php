<?php
    ...
    if (isset($_POST['submit'])) {
        if (empty($_POST['username']) || empty($_POST['password'])) {
            ...
            $acampante = mysqli_query($con,"SELECT id, Correo, Nombres, Apellidos, Edad FROM icesucre.Acampante WHERE Usuario = '" . $username . "' and Contrasena='".$password."';");
            $admin = mysqli_query($con,"SELECT id, user, password FROM icesucre.Director WHERE user = '" . $username . "' and password='".$password."';");
